...
class update_po_line_wizard(models.TransientModel):
    ...
    def update_pol(self):
        if self.import_option == 'csv':
            ...
            'x_aa_tx_extern_id', 'x_aa_tx_intern_id', 'x_aa_tx_imei', 'x_aa_tx_keyboard', 
            'x_aa_tx_other_remarks']
            try:
                ...
                if row_no <= 0:
                    ...
                    if self.product_details_option == 'from_product':
                        ...
                        values.update({
                           ...
                           'x_aa_tx_keyboard':line[18],
                           'x_aa_tx_other_remarks':line[19],
                            })
                    else:
                        values.update({
                                        'code' : line[0].split('.')[0],
        ...
        if self.product_details_option == 'from_xls':
            ...
            if purchase_order_brw.state == 'draft':
                ...
                to_update_po_line.write({
                    ...
                    'x_aa_tx_identifier': 'TR.' + purchase_order_brw.name + '/' + str(values.get('x_aa_tx_intern_id')),
                    })
    ...
    def download_auto_update(self):
        return {
             ...
             'url': '/web/binary/download_document_po?model=update.po.line.wizard&id=%s'%(self.id),
             'target': 'new',
             }
